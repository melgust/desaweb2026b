...
export class ClientListComponent implements OnInit {
  ...
  loadClients(): void {
    ...
    this.clientService
      .getClients(this.searchTerm, this.sortBy, this.sortDirection, this.pageIndex + 1, this.pageSize)
      .subscribe({
        next: (res) => {
  ...
  deleteClient(id: string): void {
    ...
    this.clientService.deleteClient(id).subscribe({
      ...
      error: (err) => this.errorMessage.set(err?.error?.message || 'Could not delete client.')
    });
  }
}
